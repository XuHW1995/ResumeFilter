...
namespace ResumeScreening
{
    public static class ExportHelp
    {
        ...
        /// string:列名
        /// </summary>
        public static Dictionary<int, string> ExcelHeadDic = SetExportExcelHead();

        /// <summary>
        /// 设置导出表表头数据
        /// </summary>
        public static Dictionary<int, string> SetExportExcelHead()
        {
        ...
        public static void DataExport(List<ResumeData> dataList, string filepath)
        {
            try
            {
                ...
                {
                    cells[0, i].PutValue(ExcelHeadDic[i]);
                }
    ...
    ////模糊搜索
    //public static List<ResumeData> SearchByInputText(string selectedPath)
    //{
    //    List<ResumeData> videolist = new List<ResumeData>();
    ...
    //    return videolist;
    //}
    //static void RecursiveSearchByMatchStr( string path, List<VideoStruct> videolist)
    //{
